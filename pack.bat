...
set JAVA_VERSION=17
set MAIN_JAR=scanet-1.0-SNAPSHOT.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\ru\fezas\scanet\ScanetApplication.class > temp.txt
...
set manual_modules=,jdk.crypto.ec,jdk.localedata,javafx.controls,javafx.graphics,javafx.fxml,java.sql
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name Scanet02b ^
  --main-class ru.fezas.scanet.ScanetApplication ^
  --main-jar %MAIN_JAR% ^
  --java-options -Xmx2048m ^
  --runtime-image target/java-runtime 
 rem --vendor "Fezas." ^
 rem --copyright "Copyright © 2019-23 Fezas" ^
 rem --win-dir-chooser ^
